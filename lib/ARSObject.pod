...
C<-name>, C<-namecgi>, C<-namedb> => 'field name'
...
field definitions by ARS db names.
...
Minimal metadata set includes explicit 'enumLimits'.
...
If !defined(minutes), soon command will be deleted from schedule.
